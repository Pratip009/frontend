    ...
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        ...
        <p>
          ...
          agreed to or set forth in writing by Learning Needs, any term or
        ...
        <p>
          ...
          website may differ from those in stores that stock Learning Needs
          products, as these stores are independent of Learning Needs. Learning
          Needs reserves the right to amend pricing for any pricing errors
          displayed due to human error, computer malfunction, or any other
          reason. Where a pricing error is identified after you have submitted
          an online order, Learning Needs will notify you of the error in
          pricing as soon as reasonably practicable, and you may elect to not
        ...
        <p>
          ...
          shipping. These offers may be for a limited time only, and Learning
        ...
        <p>
          ...
          are beyond our control. Learning Needs cannot be held liable for late
        ...
        <p>
          ...
          all claims, costs, proceedings, demands, losses, defense costs
        ...
        <p style={{ fontWeight: "500" }}>Learning Needs</p>
