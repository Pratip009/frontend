  ...
  return (
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        <h1>Privacy Policy of Learning Needs</h1>
        <p style={{ fontSize: "16px", fontWeight: "600" }}>
          {" "}
          Effective Date: 23-12-2021
        </p>
        <p>
          At Learning Needs, we value the privacy of our customers and are
        ...
        <p>
          By using the Learning Needs website and services, you agree to the
